sap.ui.define([
    ...
    "sap/ui/core/ComponentContainer"
        ...
        return BaseController.extend("main.portal.controller.Launchpad", {

            onInit: function () {
                var oMenuModel = new JSONModel(sap.ui.require.toUrl("main/portal/mockdata") + "/menu.json");
                ...
                var oModel = new JSONModel(sap.ui.require.toUrl("main/portal/mockdata") + "/apps-cm.json");
            ...
            onMenuPress: function(oEvent){
                ...
                var oModel = new JSONModel(sap.ui.require.toUrl("main/portal/mockdata") + "/apps-"+id+".json");
                this.getView().setModel(oModel);
            },
